                        ...
                        children: [
                         /* SizedBox(
                           ...
                           Text(
                            ...
                            style: TextStyle(
                              color: Colors.red,
                              fontSize: isDesktop ? MediaQuery.of(context).size.width*0.02 : MediaQuery.of(context).size.width*0.03,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: GoogleFonts.inter(color: Color.fromRGBO(255, 255, 255, 1), fontSize: MediaQuery.of(context).size.width*0.015),
                        ),
